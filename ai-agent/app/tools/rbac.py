...
TOOL_RBAC_PERMISSIONS: dict[str, set[str]] = {
    ...
    "create_department": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_OPERATIONS_MANAGER,
    },
    "update_department": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_OPERATIONS_MANAGER,
    },
    ...
    "create_zone": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_OPERATIONS_MANAGER, ROLE_DEPT_MANAGER, ROLE_PRODUCTION_SUPERVISOR,
    },
    "update_zone": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_OPERATIONS_MANAGER, ROLE_DEPT_MANAGER, ROLE_PRODUCTION_SUPERVISOR,
    },
    ...
    "add_jsa_step": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_HSE_OFFICER, ROLE_PRODUCTION_SUPERVISOR,
    ...
    "list_available_permits_for_jsa": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_HSE_OFFICER, ROLE_OPERATIONS_MANAGER,
        ROLE_DEPT_MANAGER, ROLE_PRODUCTION_SUPERVISOR, ROLE_MAINTENANCE_ENGINEER,
        ROLE_AUDITOR,
    },
    ...
    "delete_chemical": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_OPERATIONS_MANAGER, ROLE_WAREHOUSE_SUPERVISOR,
        ROLE_PRODUCTION_SUPERVISOR,
    },
    ...
    "update_chemical_stock": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_HSE_OFFICER, ROLE_OPERATIONS_MANAGER,
        ROLE_PRODUCTION_SUPERVISOR, ROLE_QUALITY_ENGINEER, ROLE_WAREHOUSE_SUPERVISOR,
    },
    "update_chemical": {
        ROLE_ADMIN, ROLE_HSE_MANAGER, ROLE_HSE_OFFICER, ROLE_OPERATIONS_MANAGER,
        ROLE_PRODUCTION_SUPERVISOR, ROLE_QUALITY_ENGINEER, ROLE_WAREHOUSE_SUPERVISOR,
...
def normalize_role(raw_role: Optional[str]) -> str:
    ...
    raw_str = str(raw_role).strip()
    clean = raw_str.upper().replace(" ", "_").replace("-", "_").replace(".", "_")
    ...
    mapping = {
        ...
        # Arabic role names
        "مشرف_إنتاج": ROLE_PRODUCTION_SUPERVISOR,
        "مشرف_انتاج": ROLE_PRODUCTION_SUPERVISOR,
        "مشرف_الإنتاج": ROLE_PRODUCTION_SUPERVISOR,
        "مشرف_الانتاج": ROLE_PRODUCTION_SUPERVISOR,
        "مدير_السلامة": ROLE_HSE_MANAGER,
        "مسؤول_السلامة": ROLE_HSE_OFFICER,
        "مسئول_السلامة": ROLE_HSE_OFFICER,
        "مهندس_صيانة": ROLE_MAINTENANCE_ENGINEER,
        "مهندس_كهرباء": ROLE_ELECTRICAL_ENGINEER,
        "مهندس_جودة": ROLE_QUALITY_ENGINEER,
        "مشرف_مخازن": ROLE_WAREHOUSE_SUPERVISOR,
        "مدير_عمليات": ROLE_OPERATIONS_MANAGER,
    }
